...
export const HeartPulse = (props: React.SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M19 14c1.49-1.46 3-3.21 3-5.5A5.5 5.5 0 0 0 16.5 3c-1.76 0-3 .5-4.5 2-1.5-1.5-2.74-2-4.5-2A5.5 5.5 0 0 0 2 8.5c0 2.3 1.5 4.05 3 5.5l7 7Z"/><path d="M3.22 12H9.5l.7-1.21 2.12 4.24 1.48-2.96H20.8"/></svg>
);

export const Stethoscope = (props: React.SVGProps<SVGSVGElement>) => (
...
export const Footprints = (props: React.SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M4 16v-2.38c0-.9.6-1.7 1.4-2.22l5.9-3.92a1.8 1.8 0 0 1 2.4 0l5.9 3.92c.8.52 1.4 1.32 1.4 2.22V16"/><path d="M12 15V7"/><path d="M12 15a2 2 0 1 0 0-4 2 2 0 0 0 0 4Z"/></svg>
);

export const BedDouble = (props: React.SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M2 18v3h20v-3"/><path d="M2 10v4h20v-4"/><path d="M12 2a8 8 0 0 0-8 8v6h16v-6a8 8 0 0 0-8-8Z"/></svg>
);

export const Map = (props: React.SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M14.106 5.553a2 2 0 0 0-2.212 0l-6.25 4.028a2 2 0 0 0-1.144 1.733V18a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2v-6.686a2 2 0 0 0-1.144-1.733l-6.25-4.028Z"/><path d="m10 10-4 4"/><path d="M14 6 8 12"/><path d="M20 12 14 6"/></svg>
);
...
export const Battery = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><rect x="2" y="7" width="18" height="10" rx="2" ry="2"></rect><line x1="22" y1="11" x2="22" y2="13"></line></svg>
);

export const Watch = (props: React.SVGProps<SVGSVGElement>) => (
...
export const PersonStanding = (props: React.SVGProps<SVGSVGElement>) => (
...
export const Lungs = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M12 22c-4 0-6-2-6-6V8a4 4 0 0 1 4-4h0a4 4 0 0 1 4 4v8c0 4-2 6-6 6Z"/><path d="M12 22c4 0 6-2 6-6V8a4 4 0 0 0-4-4h0a4 4 0 0 0-4 4v8c0 4 2 6 6 6Z"/><path d="M12 6V2"/><path d="M12 2a2 2 0 1 1 4 0"/></svg>
);
...
export const Pill = (props: React.SVGProps<SVGSVGElement>) => (
...
export const Cloudy = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M17.5 19H9a7 7 0 1 1 6.71-9h1.79a4.5 4.5 0 1 1 0 9Z"/><path d="M22 10a3 3 0 0 0-3-3h-2.207a5.502 5.502 0 0 0-10.702.5"/></svg>
);
...
export const Droplets = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M7 16.3c2.2 0 4-1.83 4-4.05 0-1.16-.57-2.26-1.7-3.02C8.13 8.5 7 7.5 7 6.3c0-1.1.9-2 2-2s2 .9 2 2c0 .34.04.67.11.98"/><path d="M10 10.3c.14-.3.29-.6.46-.88.17-.28.36-.55.57-.8.21-.25.43-.5.68-.73.25-.23.52-.45.8-.65.28-.2.58-.38.9-.53s.65-.28 1-.38c.35-.1.7-.15 1.07-.15.37 0 .72.05 1.07.15.35.1.68.23 1 .38s.62.35.9.53c.28.2.55.42.8.65.25.23.47.48.68.73.21.25.4.52.57.8.17.28.32.58.46.88.14.3.26.6.36.9.1.3.14.6.14.94a4 4 0 0 1-4.03 4.01c-1.15 0-2.24-.55-3-1.68-.76 1.13-1.85 1.68-3 1.68-2.2 0-4-1.83-4-4.05 0-1.16.57-2.26 1.7-3.02C12.13 13.5 11 12.5 11 11.3c0-.34-.04-.67-.11-.98"/></svg>
);
...
export const BatteryCharging = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M15 7h1a2 2 0 0 1 2 2v6a2 2 0 0 1-2 2h-2"/><path d="M6 7H4a2 2 0 0 0-2 2v6a2 2 0 0 0 2 2h1"/><path d="m11 7-3 5h4l-3 5"/><line x1="22" x2="22" y1="11" y2="13"/></svg>
);
...
export const PowerOff = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M18.36 6.64A9 9 0 0 1 20.77 15"/><path d="M6.16 6.16a9 9 0 1 0 12.73 0"/><path d="M12 2v4"/><path d="m2 2 20 20"/></svg>
);
...
export const BrainCircuit = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M12 2a4.5 4.5 0 0 0-4.5 4.5v.45a3.5 3.5 0 0 0-3.24 3.49c-1 .2-1.76.96-1.76 1.93V13a2.5 2.5 0 0 0 2.5 2.5h.45a3.5 3.5 0 0 0 3.49 3.24 3.5 3.5 0 0 0 3.51 3.26c.2.01.4.01.6.01 1.93 0 3.5-1.57 3.5-3.5v-.45a3.5 3.5 0 0 0 3.24-3.49c1-.2 1.76-.96-1.76-1.93V12a2.5 2.5 0 0 0-2.5-2.5h-.45A3.5 3.5 0 0 0 15 6.26 3.5 3.5 0 0 0 11.49 3A4.49 4.49 0 0 0 12 2Z"/><path d="M12 11.5a2.5 2.5 0 0 0-2.5 2.5v.01a2.5 2.5 0 0 0 2.5 2.5h.01a2.5 2.5 0 0 0 2.5-2.5v-.01a2.5 2.5 0 0 0-2.5-2.5Z"/><path d="M2.5 13a2.5 2.5 0 0 0-2.5-2.5"/><path d="M21.5 13a2.5 2.5 0 0 1 2.5-2.5"/><path d="M12 22a2.5 2.5 0 0 1 2.5-2.5"/><path d="M12 2a2.5 2.5 0 0 1-2.5 2.5"/></svg>
);
...
export const ClipboardCopy = (props: React.SVGProps<SVGSVGElement>) => (
...
export const Sos = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><circle cx="12" cy="12" r="10"></circle><path d="M10 8.3c.7-1.1 2.5-1.1 3.2 0l2.3 3.4c.7 1.1-.3 2.5-1.6 2.5H9.3c-1.3 0-2.3-1.4-1.6-2.5l2.3-3.4z"></path><path d="M12 17v.01"></path></svg>
);

export const MessageSquareText = (props: React.SVGProps<SVGSVGElement>) => (
